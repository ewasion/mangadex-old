...
$groups = new Groups($db, "group_name ASC", 2000, 0, array());; //all langs
		...
		<div class="panel-body">
			<ul>
				...
				<ul>
					...
					<li>Edge Cases:</li>
					<ul>
						<li>For chapters not released in volumes, leave the volume numbers blank.</li>
						<li>For single-volume series, use the format: Vol. 1 Ch. x</li>
						<li>For oneshots, name the chapter "Oneshot" and leave the volume and chapter numbers blank.</li>
