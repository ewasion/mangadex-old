<?php
if (in_array($_SERVER["HTTP_CF_CONNECTING_IP"], array("82.118.236.79", "49.150.43.112", "159.224.48.26", "88.207.195.180", "95.19.93.179"))) die("Your IP has been banned due to abnormal behaviour which may indicate that you are a bot. Contact anidex.moe@gmail.com if that is not the case.");
...
switch ($page) {
	...
	case "chapter":
		$chapter = $db->get_row(" SELECT mangadex_mangas.manga_name, mangadex_chapters.volume, mangadex_chapters.chapter, mangadex_chapters.title 
	...
	case "manga":
		$manga_name = $db->get_var(" SELECT manga_name FROM mangadex_mangas WHERE manga_id = '{$_GET['id']}'; ");
		$title = $manga_name . " (Manga) - " . TITLE;
		break;
...
<head>
	...
	<meta name="keywords" content="manga, reader">

	<meta property="og:site_name" content="<?= TITLE ?>">
	<meta property="og:title" content="<?= $title ?>">
	<meta property="og:image" content="/images/user_logos/default.png">
	...
	<link href="/scripts/css/theme.css?v=2" rel="stylesheet">
...
<?php require_once(ABSPATH . "/scripts/analytics.req.php"); ?>
	...
	<div class="container" role="main">
		...
		<div id="announcement" class="alert alert-success alert-dismissible text-center" role="alert">
			...
			<?php } ?>
			<strong>Update (13-Feb)</strong> <strong>Notice:</strong> Hentai toggle changed for the final time. You can enable the hentai in your user settings, and then use the toggle as before.<br />Apologies for the lag - the site is hitting record numbers of visitors. A more powerful server is being prepared for this week!</div>
		<?php } ?>
